...
test tests[] = {
    ...
    test_natural_count_bits_0,
    test_natural_count_bits_1,
    test_natural_count_bits_2,
    test_natural_count_bits_3,
    test_natural_add_0,
    test_natural_add_1,
    test_natural_add_2,
    test_natural_add_3,
    test_natural_add_4,
    test_natural_add_5,
    test_natural_subtract_0,
    test_natural_subtract_1,
    test_natural_subtract_2,
    test_natural_subtract_3,
    test_natural_subtract_4,
    test_natural_subtract_5,
    test_natural_subtract_6,
    test_natural_subtract_7,
    ...
    test_natural_lshift_0,
    test_natural_lshift_1,
    test_natural_lshift_2,
    test_natural_lshift_3,
    test_natural_lshift_4,
    test_natural_rshift_0,
    test_natural_rshift_1,
    test_natural_rshift_2,
    test_natural_rshift_3,
    test_natural_rshift_4,
    test_natural_multiply_0,
    test_natural_multiply_1,
    test_natural_multiply_2,
    test_natural_multiply_3,
    test_natural_multiply_4,
    test_natural_divide_0,
    test_natural_divide_1,
    test_natural_divide_2,
    test_natural_divide_3,
    test_natural_divide_4,
    test_natural_divide_5,
    test_natural_divide_6,
    test_natural_gcd_0,
    test_natural_gcd_1,
    test_natural_gcd_2,
    test_natural_gcd_3,
    ...
    test_integer_add_2,
    test_integer_add_3,
    test_integer_subtract_0,
    test_integer_subtract_1,
    test_integer_subtract_2,
    test_integer_subtract_3,
    ...
    test_integer_lshift_0,
    test_integer_lshift_1,
    test_integer_lshift_2,
    test_integer_lshift_3,
    test_integer_lshift_4,
    test_integer_rshift_0,
    test_integer_rshift_1,
    test_integer_rshift_2,
    test_integer_rshift_3,
    test_integer_rshift_4,
    test_integer_multiply_0,
    test_integer_multiply_1,
    test_integer_multiply_2,
    test_integer_multiply_2,
    test_integer_divide_0,
    test_integer_divide_1,
    test_integer_divide_2,
    test_integer_divide_3,
    test_integer_divide_4,
    ...
    test_rational_add_2,
    test_rational_add_3,
    test_rational_subtract_0,
    test_rational_subtract_1,
    test_rational_subtract_2,
    test_rational_subtract_3,
    ...
    test_rational_multiply_0,
    test_rational_multiply_1,
    test_rational_multiply_2,
    test_rational_multiply_3,
    test_rational_divide_0,
    test_rational_divide_1,
    test_rational_divide_2,
    test_rational_divide_3,
    test_rational_divide_4,
